(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('protocol', ['exports'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.protocol = {}));
    ...
    })(exports.PropType || (exports.PropType = {}));
    exports.PropertyQueryTypes = void 0;
    ...
    })(exports.PropertyQueryTypes || (exports.PropertyQueryTypes = {}));
    ...
    ***************************************************************************** */
    ...
    var PriorityAwareMessageBus = /** @class */ (function (_super) {
        __extends(PriorityAwareMessageBus, _super);
        function PriorityAwareMessageBus(_bus, _setTimeout) {
            if (_setTimeout === void 0) { _setTimeout = setTimeout; }
        ...
        PriorityAwareMessageBus.prototype.on = function (topic, cb) {
            var self = this;
        ...
        PriorityAwareMessageBus.prototype.once = function (topic, cb) {
            var self = this;
        ...
        PriorityAwareMessageBus.prototype.emit = function (topic, args) {
            var e_1, _a;
            var _this = this;
            ...
            var blockedBy = TOPIC_BLOCK_SEQUENCE[topic];
            if (blockedBy) {
                try {
                    // The source code here is safe.
                    // TypeScript type inference ignores the null check here.
                    // tslint:disable-next-line: no-non-null-assertion
                    for (var blockedBy_1 = __values(blockedBy), blockedBy_1_1 = blockedBy_1.next(); !blockedBy_1_1.done; blockedBy_1_1 = blockedBy_1.next()) {
                        var blocker = blockedBy_1_1.value;
                    ...
                    try {
                        if (blockedBy_1_1 && !blockedBy_1_1.done && (_a = blockedBy_1.return)) _a.call(blockedBy_1);
                    }
            ...
            if (THROTTLE_METHODS[topic]) {
                ...
                this._setTimeout(function () { return (_this._throttled[topic] = false); }, THROTTLE_METHODS[topic]);
            }
            return this._bus.emit(topic, args);
        };
        PriorityAwareMessageBus.prototype.destroy = function () {
            this._bus.destroy();
        };
        PriorityAwareMessageBus.prototype._afterMessage = function (topic) {
            var request = TOPIC_REQUEST[topic];
            if (!request) {
                return;
            }
        ...
        return PriorityAwareMessageBus;
    }(MessageBus));
    ...
    exports.PriorityAwareMessageBus = PriorityAwareMessageBus;

    Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=protocol.umd.js.map
